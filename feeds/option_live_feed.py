...
class Nse:
    ...
    def get_all_strikes_dataframe(self):
        try:
        ...
        ce_values = [data['CE'] for data in json_data['records']['data'] if "CE" in data]
        pe_values = [data['PE'] for data in json_data['records']['data'] if "PE" in data]
        ...
        columns_ce = ['openInterest', 'changeinOpenInterest', 'totalTradedVolume']
        columns_pe = ['totalTradedVolume', 'changeinOpenInterest', 'openInterest']

        merged_inner = pandas.merge(left=ce_data, right=pe_data)
        merged_inner.columns = ['Open Interest', 'Change in Open Interest', 'Traded Volume',
    ...
    def main(self):
        ...
        try:
            ...
            df, current_time, self.underlying_stock, self.points = self.get_all_strikes_dataframe()
        except TypeError:
